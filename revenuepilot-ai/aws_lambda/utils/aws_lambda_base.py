...
def get_mongo_client() -> Any:
    ...
    if _mongo_client_instance is None:
        ...
        try:
            ...
            logger.info("[MongoDB Base] MongoClient initialized & connected to Atlas/Local")
...
class LambdaConfig:
    def __init__(self):
        self.aws_mode: str = os.environ.get("AWS_MODE", "local").strip().lower()
        self.is_local_mode: bool = self.aws_mode != "aws"
        ...
        self.ses_sender_email: str = os.environ.get("SES_SENDER_EMAIL", "noreply@revenuepilot.ai").strip()
